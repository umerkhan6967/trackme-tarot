...
const FALLBACK_ARCHETYPES = [
  {
    ...
    fortune: 'Bhai, your local clock confirms it is late night and yet here you are letting a website read your soul. At least 14 tabs of existential questions and dead Reddit threads are open right now. Go to sleep yaar, the tracking algorithms will still be here waiting for you in the morning.',
    ...
    exposure_tips: [
      ...
      'Hydrate karo aur screen brightness thori kam karo.',
  ...
  },
  {
    ...
    fortune: 'Your battery level is screaming in red, yet you are out here casually inspecting cyber-tarot fortunes with zero charger in sight. Absolute chaotic energy, living life on 1% battery and pure hopium. Bro thrives on low-voltage adrenaline.',
  ...
  },
  {
    ...
    exposure_tips: [
      'Nobody in your team can tell the difference between your 4 versions of Roboto.',
  ...
  },
  {
    ...
    fortune: 'Bait ad container status: completely vaporized into quantum dust. You think you are invisible behind your custom DNS filters and extensions, yaar. But your canvas fingerprint just broadcast your identity to the entire server room anyway.',
    ...
    exposure_tips: [
      ...
      'Clear your browser cache once in a while, paranoid dost.'
    ]
  },
  {
    ...
    fortune: 'Barely 2 CPU threads detected and your device memory is fighting for its life in the trenches. Every time you open 3 browser tabs simultaneously, your cooling fan sounds like an Emirates Boeing 777 preparing for takeoff. Respect for the hustle though, this machine is a certified survivor.',
  ...
  },
  {
    ...
    fortune: 'Mashallah, 12+ execution threads and enough compute power to simulate orbital rocket trajectories. And yet 92% of this horsepower is dedicated to watching 1080p YouTube videos and hoarding 38 inactive tabs. Paisa wasool hardware, but questionable life balance.',
    prediction: 'You will browse Amazon tonight for another mechanical keyboard or desk accessory you 100% do not need.',
    exposure_tips: [
      ...
      'Stop running Cinebench just to stare at the score.'
    ]
  },
  {
    id: 'doomscroll-deity',
    ...
    exposure_tips: [
      'Fix your neck posture right now—shrimp spine detected.',
  ...
  },
  {
    ...
    fortune: 'Screen width exceeds 2560 pixels! Bro is browsing the web in IMAX panoramic format. You have enough screen real estate to host a small family wedding, yet your attention remains locked onto one tiny chat window waiting for a typing indicator.',
  ...
  },
  {
    ...
    fortune: 'Do-Not-Track header is proudly set to 1. How innocent! Commercial ad networks receive that flag, smile politely, and catalog your device canvas hash with 99.4% precision anyway. Your optimism is truly commendable, dost.',
  ...
  },
  {
    ...
    fortune: 'Three or more active language locales detected in your headers. You switch between English, Urdu, and internet slang mid-sentence and your autocorrect has completely given up trying to understand your grammar. Truly international aura with localized emotional stress.',
    prediction: 'You will accidentally type an entire paragraph in the wrong keyboard layout and hit send before noticing.',
    exposure_tips: [
      'Teach your dictionary that "yaar" and "bhai" are valid words.',
  ...
  },
  {
    ...
    fortune: 'Reduced motion preference active! You have zero tolerance for spinning 3D cubes or frivolous bouncing banners. Pure utilitarian speed and tranquility, peaceful like an early morning walk in Shalimar Gardens before traffic wakes up.',
  ...
  },
  {
    ...
    fortune: 'Your browser signals are so impeccably average that data brokers use your profile as the statistical baseline for the human race. Zero suspicious flags, zero unusual fonts, just pure unseasoned consumer stability. Dil se normal.',
